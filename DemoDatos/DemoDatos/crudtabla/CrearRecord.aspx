...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="formularioCreacion" style="padding:20px;">
        ...
        <br />
        <table id="tablaCrear" border="1" width="100%" cellpadding="10">
            <tr>
            ...
            <tr>
                ...
                <td style="height: 12px">
                    <asp:Button ID="btn_Aceptar" runat="server" Text="Grabar Registro" OnClick="btn_Aceptar_Click" Width="104px" />
                    &nbsp;&nbsp;&nbsp;
