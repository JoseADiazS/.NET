...
{
    internal class DolaresAmericanos : InterfaceConversionMonedas
    {
        ...
        /// <param name="direccionDeConversion">The direccion de conversion.</param>
        ...
        {
            double bandera = valorAConvertir * 0.00025;
            return bandera;
        }
